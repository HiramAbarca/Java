...
class Promedio6{
  ...
  while(repetir != "no"){
    ...
    //si tiene reporte se le quita un7 punto
    int rep;
    ...
    System.out.println("El mayor promedio es de: " + alta + ", la cual corresponde a " + nombreAlto);
    System.out.println("El menor promedio es de: " + baja + ", la cual corresponde a " + nombreBajo);
